...
public class Podcast {
    ...
    public String toString() {
        return "Podcast{" + "podcast_name='" + podcast_name + '\'' + ", podcast_id=" + podcast_id + ", podcast_duration='" + podcast_duration + '\'' + ", podcast_episode='" + podcast_episode + '\'' + ", podcast_lang='" + podcast_lang + '\'' + ", podcast_file_path='" + podcast_file_path + '\'' + ", p_id=" + p_id + '}';
    }
}